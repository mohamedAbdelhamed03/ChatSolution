...
Authoritative plan: [DOC-156 Phase 4 Messaging Services Plan](20.3-phase-4-messaging-services-plan.md).

Planned architecture sprints (catalog AD IDs):

1. AD-042 Delivery & Acknowledgements
2. AD-044 Read Receipts
3. AD-011 / AD-043 Presence & Typing
4. AD-051 Reactions & Message Interactions
5. AD-054 Media & Attachment Services
