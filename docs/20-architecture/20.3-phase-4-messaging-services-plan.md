...
| **Phase Status** | In Progress — Sprint 1 (AD-042) |
...
**Status:** Research + Workshop + Review complete — AD-042 Under Review.
...
| Decision | [AD-042](../architecture-decisions/AD-042-delivery-semantics.md) — Under Review |

### Sprint 2 — AD-044 Read Receipts

Builds on Delivery and Synchronization (AD-010).
